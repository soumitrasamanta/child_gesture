...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, nb_classes=12, channel=20):
...
def resnet18(pretrained=False, channel= 20, nb_classes=12, **kwargs):
...
def resnet34(pretrained=False, channel= 20, nb_classes=12, **kwargs):
...
def resnet50(pretrained=False, channel= 20, nb_classes=12, **kwargs):
...
def resnet101(pretrained=False, channel= 20, nb_classes=12, **kwargs):
